...
public interface FullPrunedBlockStore extends BlockStore, UTXOProvider {
     ...
     */
    void addTransactionInput(UTXO out) throws BlockStoreException;

    void addTransactionOutput(UTXO out) throws BlockStoreException;
     ...
     * @throws BlockStoreException
     */
    void removeTransactionInput(UTXO out) throws BlockStoreException;
